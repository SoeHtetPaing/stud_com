                ...
                <nav>
                    ...
                    <div class="d-flex flex-column flex-shrink-0">
                        <ul class="nav nav-pills flex-column mb-auto">
                            ...
                            <li class="nav-item py-1">
                                <a href="{{route('student@department')}}" class="nav-link active-vertical-menu">
                    ...
                    <div class="lg-profile d-flex justify-content-between">
                        <div class="d-flex">
                            <div class="position-relative p-2">
                                <a href="{{route('user@chat', ['back' => 'student@department'])}}">
                        ...
                        <div class="row px-md-5">
                            ...
                            @else
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-hover" style="width: 1130px;">
                                            @foreach ($member as $r)
                                            <tr>
                                                <td>
