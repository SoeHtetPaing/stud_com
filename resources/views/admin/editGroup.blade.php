        ...
        <div class="row mx-md-5">
            ...
            <div class="col-sm col-md-6 py-3">
                ...
                <div class="d-flex mt-1 mb-3">
                    <div class="">
                        @if ($data["image"] == null)
                        <img src="{{ asset('storage/upload/group-icon-v3.jpg') }}" alt="profile" class="logo-icon rounded-circle">
                        @else
                        <img src="{{ asset('storage/upload/'.$data->image) }}" alt="profile" class="logo-icon rounded-circle">
                        @endif
                    </div>
            ...
            <div class="col-sm col-md-6 bg-white rounded" style="height: 675px; overflow-y: scroll;">
                ...
                @else
                    ...
                    <div class="bg-white pt-3 rounded" style="position: sticky; top: 0; z-index: 11;">
                        ...
                        <div class="divider bg-light m-0 p-0 mx-1 mb-2"></div>
                    </div>
