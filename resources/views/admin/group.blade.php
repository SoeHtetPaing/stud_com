                ...
                <nav>
                    ...
                    <div class="d-flex flex-column flex-shrink-0">
                        <ul class="nav nav-pills flex-column mb-auto">
                            ...
                            <li>
                                <a href="{{route('admin@manageGroup')}}" class="nav-link active-vertical-menu">
                    ...
                    <div class="lg-profile d-flex justify-content-between">
                        <div class="d-flex">
                            <div class="position-relative p-2">
                                <a href="{{route('user@chat', ['back' => 'admin@manageGroup'])}}">
                ...
                <div class="row text-dark">
                    ...
                    <div class="col-sm col-lg-8">
                        ...
                        <div class="mb-3">
                            <div class="bg-white border rounded-pill">
                                <form action="{{route('admin@manageGroup')}}" method="get">
                                        ...
                                        <div class="col-sm col-md-12 col-lg-6 col-xl-6 mb-3">
                                            <div class="card">
                                                        ...
                                                        <div class="d-flex align-item-center">
                                                            <div class="position-relative">
                                                                ...
                                                                <p class="profile-date" style="bottom: -1.3rem; font-family: 'Source Serif 4';">
                                                                    ...
                                                                    <img src="{{asset('storage/upload/'.$r->profile_photo.'')}}" alt="creater-photo" style="width: 12px; height: 12px;" class="rounded-circle mx-1">
                                                ...
                                                <div class="card-footer text-end">
                                                    ...
                                                    <a href="{{route('admin@editGroup', $r['id'])}}" class="text-decoration-none">
                    ...
                    <div class="col-sm col-lg-4 bg-white pt-3"  style="position: sticky; top: 65px; z-index: 10; height: 700px; overflow-y: scroll;">
                        ...
                        <div class="accordion mb-5" id="groupAccordion">
                            ...
                            <div class="accordion-item rounded mb-3">
                                <h2 class="accordion-header">
                                  <button class="accordion-button border-top rounded-top" type="button" data-bs-toggle="collapse" data-bs-target="#groupThree" aria-expanded="true" aria-controls="collapseOne">
                                      <i class="fa-solid fa-plus-circle me-3"></i> Create Custom Group
                                  </button>
                                </h2>
                                <div id="groupThree" class="accordion-collapse collapse show" data-bs-parent="#groupAccordion">
                                  <div class="accordion-body">
