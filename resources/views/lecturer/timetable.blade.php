                ...
                <nav>
                    ...
                    <div class="d-flex flex-column flex-shrink-0">
                        <ul class="nav nav-pills flex-column mb-auto">
                            ...
                            <li class="nav-item py-1">
                                <a href="{{route('lecturer@timetable')}}" class="nav-link active-vertical-menu">
                                    <i class="bi-table"></i>
                    ...
                    <div class="lg-profile d-flex justify-content-between">
                        <div class="d-flex">
                            <div class="position-relative p-2">
                                <a href="{{route('user@chat', ['back' => 'lecturer@timetable'])}}">
                ...
                <div class="row text-dark">
                    ...
                    @if (count($tt) == 0)
                     ...
                     <div class="table-responsive mt-5">
                        <h5 class="ms-lg-4">{{$dept->name}} » {{$user->name}} » Timetable</h5>
                            ...
                            @php
                                ...
                                echo "<tr>";
                                    ...
                                    foreach ($day as $t) {
                                        ...
                                        if ($interval == 2) {
                                          echo "<td colspan='2'>".$t["subject_code"]." (".substr($t["section"], strpos($t["section"], " ")+1).")"."</td>";
                                        } else {
                                          echo "<td>".$t["subject_code"]." (".substr($t["section"], strpos($t["section"], " ")+1).")"."</td>";
