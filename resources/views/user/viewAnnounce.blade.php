    ...
    <div class="container" style="min-height: 100vh; background-color: rgba(0, 151, 178, 0.025)">
        <div class="row">
            ...
            <div class="col-sm col-md-8 offset-md-2 col-lg-6 offset-lg-3 p-3">
                ...
                <div class="d-flex justify-content-between align-items-center mt-3 mb-2">
                    <div class="">
                        <h6 class="d-inline-block"><i class="fa fa-info-circle me-lg-2"></i><span class="d-none d-md-inline">Announcement Details</span></h6>
                    </div>
        ...
        <div class="row">
            <div class="col-3 offset-8">
                <a href="{{ url()->previous() }}"><button class="btn btn-ucsp me-3 my-1">Done</button></a>
            </div>
        </div>
    </div>
@endsection
